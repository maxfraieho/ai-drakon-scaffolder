---
name: sdd-refactor
description: Guide and execute the SDD Refactoring / Performance workflow (Template 3) for ai-drakon-scaffolder — benchmark before and after, no public-contract breaks.
---
...
4. Check all callers via gitnexus, then apply the optimization.
