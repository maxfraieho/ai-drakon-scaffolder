export const PRE_ANALYZED_ANALYSIS = {
  "generatedAt": "2026-05-10T02:07:02.451Z",
  "config": {
    "projectRoot": ".",
    "entryPaths": [
      "src",
  ...
  "summary": {
    ...
    "functions": [
      ...
      },
      {
        ...
        "returnType": "{ label?: React.ReactNode; icon?: React.ComponentType; } & ({ color?: string; theme?: never; } | { color?: never; theme: Record<keyof typeof THEMES, string>; })",
        "isExported": false
      },
      {
        "name": "ChartStyle",
