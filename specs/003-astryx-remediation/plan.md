...
- **T-321: DECISION (operator, 2026-08-19): LandingPage stays a SEPARATE marketing design, NOT migrated to Astryx.** `src/pages/LandingPage.tsx` — do not touch its token system. Acceptance: no Astryx-migration edits to LandingPage.tsx in this plan; confirmed out of scope.
