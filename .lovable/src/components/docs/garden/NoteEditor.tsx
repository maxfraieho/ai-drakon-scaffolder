...
<Button size="sm" className="h-7 px-2" onClick={() => void onSave()} disabled={isSaving ||
!isDirty} title="Зберегти">
{isSaving ? <Loader2 className="h-3.5 w-3.5 animate-spin md:mr-1" /> : <Save
className="h-3.5 w-3.5 md:mr-1" />}
