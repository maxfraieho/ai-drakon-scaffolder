...
border-[var(--border-subtle)] bg-[var(--bg-surface)] overflow-hidden">
{/ Header /}
<div className="flex h-7 shrink-0 items-center justify-between border-b
border-[var(--border-subtle)] px-2.5">
...
title="Нова схема"
className="inline-flex h-5 w-5 items-center justify-center rounded text-[var(--text-muted)]
...
onClick={() => setTab(t.id)}
className={cn(
"flex-1 rounded-sm py-0.5 text-center font-mono text-[10px] uppercase tracking-wider
transition-colors",
tab === t.id
...
placeholder="Пошук…"
className="h-6 w-full rounded-sm border border-[var(--border-subtle)] bg-[var(--bg-elevated)]
pl-7 pr-2 font-mono text-[11px] text-[var(--text-primary)] placeholder:text-[var(--text-muted)]
outline-none focus:border-[var(--accent-amber)]"
/>
</div>
{/ Tree /}
...
type="button"
onClick={onNewFolder}
className="flex w-full items-center justify-center gap-1.5 rounded-sm border border-dashed
border-[var(--border-default)] py-1 font-mono text-[10px] uppercase tracking-wider
...
return (
<div className="flex h-9 shrink-0 items-center gap-2 border-b border-[var(--border-subtle)]
bg-[var(--bg-surface)] px-2.5">
...
className={cn(
"inline-flex h-6 items-center gap-1 rounded-sm border px-2 font-mono text-[11px]
transition-colors",
analysisActive
...
title="Редагувати"
className="inline-flex h-6 w-6 items-center justify-center rounded-sm text-[var(--text-muted)]
hover:bg-white/5 hover:text-[var(--text-primary)]"
>
