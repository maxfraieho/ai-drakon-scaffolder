...
function ColorInput({ value, onChange, error }: { value: string; onChange: (v: string) => void;
error?: string | null }) {
...
export function FormatInspector({ open, title, style, onConfirm, onCancel }:
...
<pre className="text-[11px] font-mono bg-muted rounded-md p-3 max-h-40 overflow-auto
whitespace-pre-wrap">
{jsonOutput}
</pre>
<Button
