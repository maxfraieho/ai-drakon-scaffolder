...
<Button size="icon" variant="ghost" className={btn} title="Жирний" onClick={() =>
onWrap("", "", "текст")}>
<Bold className="h-3.5 w-3.5" />
</Button>
<Button size="icon" variant="ghost" className={btn} title="Курсив" onClick={() =>
onWrap("", "", "текст")}>
<Italic className="h-3.5 w-3.5" />
</Button>
<Button size="icon" variant="ghost" className={btn} title="Заголовок" onClick={() =>
onInsert("\n# Заголовок\n")}>
<Heading1 className="h-3.5 w-3.5" />
</Button>
<Button size="icon" variant="ghost" className={btn} title="Код" onClick={() => onWrap("",
"", "code")}>
<Code className="h-3.5 w-3.5" />
</Button>
<Button size="icon" variant="ghost" className={btn} title="Список" onClick={() =>
onInsert("\n- ")}>
