...
: <FileCode2 className={cn("h-3 w-3 shrink-0", selectedName === name ?
"text-[var(--accent-amber)]" : "text-[var(--text-muted)]")} />}
...
<span className="font-mono text-[9px] text-[var(--text-muted)]">{diagrams.length} схем ·
клік = відкрити</span>
</div>
)}
</aside>
