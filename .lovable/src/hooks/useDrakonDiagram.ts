...
import { readDiagramsFromStorage, removeDiagramFromStorage, upsertDiagramInStorage }
...
const nested = ((raw.diagram as Record<string, unknown> | undefined) ?? raw) as unknown as
Diagram["diagram"];
...
localStorage.setItem(getDiagramStorageKey(variables.diagramId),
